      ...
      const fallbackItems: Product[] = [
        {
          ...
          price: 14999,
          shortDescription: 'Model AVND50H • 50-Pad Storage • LCD Display & Battery Backup • Made in India',
        ...
        },
        {
          ...
          price: 14500,
          shortDescription: 'Model SND 500 • 2500W Heater • LCD Temp Display • 15-Min Auto Cutoff • Ceramic Insulation',
          description: 'Compact Sanitary Napkin & Mask Incinerator machine with lowest power consumption, automatic thermosensor, and 500-800 napkin daily burn capacity. CE approved & CPCB compliant.',
          status: 'ACTIVE',
          createdAt: new Date().toISOString(),
          updatedAt: new Date().toISOString(),
          images: [
