...
const SAMPLE_CATEGORY_PRODUCTS = [
  ...
  {
    name: 'AXA SND 500 Sanitary Napkin & Mask Incinerator Machine',
    slug: 'axa-ecoburn-100-sanitary-napkin-disposal-machine',
    shortDescription: 'Compact Sanitary Napkin & Mask Incinerator with 2500W heater, LCD temp display, 15-min auto cutoff & ceramic insulation.',
    description: 'SND 500 is one of the most compact Sanitary Napkin & Mask Incinerators in the world. Consumes lowest power in its class with an inbuilt automatic thermosensor for efficient operation, long running, and overheat protection. Wall-mounted and table-top ready. Burns 500 to 800 napkins or 2000 to 2500 masks daily into less than 1g ash per napkin. CE approved and tested as per CPCB norms.',
    price: 14500.00,
    status: ProductStatus.PUBLISHED,
    featured: true,
